/**
 ******************************************************************************
 * @file    RemoteDR16Driver.hpp
 ******************************************************************************
 */
#ifndef __REMOTE_DR16_DRIVER_HPP
#define __REMOTE_DR16_DRIVER_HPP

#include <stdint.h>
#include "prm_interfaces/msg/remote_dr16_data.hpp"

#define REMOTE_STICK_MAX (660.0f)
#define MOUSE_SPEED_MAX (660.0f)
...
{
public:
    void get_msg(prm_interfaces::msg::RemoteDR16Data& msg);
    void decode(uint8_t *buffer);
    Remote_t remote_;
private:
    uint8_t remote_buffer_[18];
};


#endif //__REMOTE_DR16_DRIVER_HPP
